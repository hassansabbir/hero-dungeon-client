...
const SubscribeSection = () => {
  return (
    <div>
      <div className="flex gap-3 justify-center items-center md:text-6xl font-extrabold text-center ">
        <FaPhone className="h-9 text-purple-600 w-9" />
        <h2>
          {" "}
      ...
      >
        ...
        <div className="absolute top-0 text-purple-600 right-0 bg-gradient-to-b h-[500px] md:pt-10 w-full from-white">
          ...
          <p className="text-2xl w-2/3 mx-auto my-5 text-center font-bold">
            Iplor sit amet consectetur adipisicing elit. Eveniet suscipit nobis
            in perferendis quam qui.
          </p>
